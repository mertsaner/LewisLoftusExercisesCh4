...
public class RollingDice {
    ...
    public static void main(String[] args)
    {
        ...
        //============ !IMPORTANT!=====
        //System.out.println("First Die One: " + die1 + ", Die Two: " + die2);//We are printing the object, when we print an object
        //System.out.println("1 Die One: " + die1.toString() + ", Die Two: " + die2.toString());
        System.out.println("Die One: " + die1.getFaceValue() + ", Die Two: " + die2.getFaceValue()); //The following line works and does the same job with the line above //Expected Writing, let see what it prints
        //===============================================================================================
        ...
        die2.roll();
        System.out.println("======Dies are rolled!=====");
        ...
        System.out.println(die1.equals(5));
        System.out.println(die2.equals(5));
        System.out.println("=====Equals comes out!======");
        ...
        //System.out.println("See the prints: ");
